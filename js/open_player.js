    ...
    methods: {
        ...
        initjiStats: function() {
            ...
            for (let player of this.ji_stats_data) {
                ...
                player['clear_grade_6_ending_1'] = player['clear_endings_6']['1'] || -1;
                player['clear_grade_6_ending_2'] = player['clear_endings_6']['2'] || -1;
                player['clear_grade_6_ending_3'] = player['clear_endings_6']['3'] || -1;
                player['clear_grade_6_ending_4'] = player['clear_endings_6']['4'] || -1;
                player['clear_grade_6_ending_5'] = player['clear_endings_6']['5'] || -1;
                let nd = new Date();
                let tz = Intl.DateTimeFormat().resolvedOptions().timeZone;
